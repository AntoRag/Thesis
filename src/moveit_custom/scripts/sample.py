...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def __init__(self):
    ...
    # self.robot_model = ['locobot_wx250s']
    ...
    ## the robot:
    self.robot = moveit_commander.RobotCommander('/locobot/robot_description')

    ## Instantiate a `PlanningSceneInterface`_ object.  This object is an interface
    ## to the world surrounding the robot:
    self.scene = moveit_commander.PlanningSceneInterface('/locobot')
...
def main():
    ...
    # input()
    # joint_target = [pi, pi,pi, 0, 0, 0]
    # tutorial.go_to_joint_state(joint_goal=joint_target)
