...
def main():
    ...
    pose5 = [-0.124719798649821,
            -0.536481135443239,
            -0.005344875617366, 
            -0.560622122515074,
            0.031739640504351,
            1.080399702856175]
    angles5 = [-1.6963656122852244, 1.0455409513406855, -0.16181043644606039, -2.6714226618566355, 0.906172816795028, 2.289361423041897]
    pose6 = [0.053973409342308,
            0.397506036836248,
            0.072462938204405,
            1.101828942850148,
            -0.589425892279432,
            -1.566336296035390]
    angles6 =[1.3682553238198603, 0.8869057787393948, 0.49874711967634844, 2.9543910360468537, 1.9786347677532579, 1.1430558285240662]

    pose_target = [pose1,pose2,pose3,pose4,pose5,pose6]
    joint_target=[angles1,angles2,angles3,angles4,angles5,angles6]
    i = 0
    while i<6:
