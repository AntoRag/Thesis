...
void pose_callback(geometry_msgs::Pose pose_goal)
{
    // robot is occupied
    ...
    goal.target_pose.pose.position.x = pose_goal.position.x - 0.1;
    goal.target_pose.pose.position.y = pose_goal.position.y - 0.1;
    goal.target_pose.pose.orientation.z = 0;
    goal.target_pose.pose.orientation.w = 0; // da decidere
    ac.sendGoal(goal);
    ac.waitForResult();
    ...
    ros::WallDuration(1.0).sleep();
    pick(move_group_interface_arm,move_group_interface_gripper);
...
void pick(moveit::planning_interface::MoveGroupInterface &arm_group,moveit::planning_interface::MoveGroupInterface &gripper_group, geometry_msgs::Pose &goal_pose)
{
    ...
    // END_SUB_TUTORIAL
    gripper_group.setPoseTarget()
void place(moveit::planning_interface::MoveGroupInterface &arm_group,moveit::planning_interface::MoveGroupInterface &gripper_group,geometry_msgs::Pose &goal_pose)
{
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface &planning_scene_interface, geometry_msgs::Pose &goal_pose, moveit::planning_interface::MoveGroupInterface &move_group_interface_arm)
{
